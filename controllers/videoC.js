...
//일본 동영상 API
const VideoURLJ = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//독일 동영상 API
const VideoURLG = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//한국 동영상 API
const VideoURLK = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.status(200).json({ result: true, msg: "성공!!", "한국1": "첫번째 동영상", "한국2": "두번째 동영상", "한국3": "세번째 동영상", "한국4": "네번째 동영상" });
    }
    catch (error) {
        console.info(error);
        console.info('여기서 오류발생');
